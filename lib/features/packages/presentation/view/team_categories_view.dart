...
class _TeamCategoriesFirstTeamViewState extends State<TeamCategoriesFirstTeamView> {
  ...
  void initState() {
    super.initState();
    maxSelectableCategories = widget.limit ~/ 2; // نصف الـ limit
  }
  ...
  void _toggleCategorySelection(int categoryId) {
    setState(() {
      ...
      } else if (selectedCategoriesForFirstTeam.length < maxSelectableCategories) {
        // اختيار الفئة إذا لم يصل للحد الأقصى
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 20),
                      Text(
                        ' عدد الفئات المسموح به ${widget.limit}\nو مسموح لكل فريق اختيار عدد ${maxSelectableCategories} من الفئات ',
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                print('📋 الفئات المختارة للفريق الأول: $selectedCategoriesForFirstTeam');
